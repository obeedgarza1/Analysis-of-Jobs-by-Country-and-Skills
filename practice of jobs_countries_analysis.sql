...
is like $700 more, it seems also that Delhi is a city that maybe you could struggle to live in,
Shanghai looks like is the worst one by the negative total, it could be that since this city is
the biggest one of all China is making it expensive to live because is a lot of people looking
for a place to live, and they could end by offering more than normal for de demand it has, could
be the same for Delhi, and it seems is already happening in Mexico City but not as bad 
for the moment*/
